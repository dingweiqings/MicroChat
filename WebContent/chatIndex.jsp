...
function ShowOnline(){
	var loader=new net.AjaxRequest("showOnline.jsp?nocache="+new Date().getTime(),deal_online,onerror,"GET");
}
...
function deal_online(){
	showOnline.innerHTML=this.req.responseText;
}
...
function set(selectPerson){	//自动添加聊天对象
	if(selectPerson!="<%=session.getAttribute("name")%>"){
		form1.tempuser.value=selectPerson;
	}else if(selectPerson=="")
		form1.tempuser.value=selectPerson="所有人";
	else{
		alert("请重新选择聊天对象！");
	}
}
...
<table width="778" height="148" border="0" align="center" cellpadding="0" cellspacing="0" background="images/top.jpg">
  <tr>
    <td background="./images/chatIndexTop.jpg">&nbsp;</td>
  </tr>
</table>
<table width="778" height="276" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="165" valign="top" bgcolor="#FDF7E9" id="showOnline" style="padding:5px">在线人员列表</td>
...
<form action="send.jsp" name="form1" method="post" onSubmit="return check()">
  <tr>
    ...
    <td height="37" align="left">[<%=session.getAttribute("name")%> ]对
      <input name="tempuser" type="text" value="所有人" size="35" readonly="readonly">
表情
...
说： </td>
  ...
  <tr>
    <td height="30" align="left">&nbsp;</td>
    <td colspan="2" align="center" class="word_dark">&nbsp;All CopyRights by reserved Kurt.Ding</td>
    <td align="center">&nbsp;</td>
  </tr>
</form>
</table>
